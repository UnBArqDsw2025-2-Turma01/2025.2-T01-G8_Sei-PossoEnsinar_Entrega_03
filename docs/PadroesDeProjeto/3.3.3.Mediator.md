...
    <p>A apresentação completa da implementação e dos resultados do Padrão Mediator pode ser visualizada através do link abaixo:</p>
    
    <p><a href="https://youtu.be/36nSn_0SQJ8" target="_blank">Link para o Vídeo de Apresentação</a></p>
