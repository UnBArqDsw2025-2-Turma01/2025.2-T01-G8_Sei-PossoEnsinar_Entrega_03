...
- [Código rodando](https://drive.google.com/drive/folders/10yDrbnhRU_SycGYh2_g6JScy2r77sV-l?usp=drive_link)<br>
  Participantes: Yan Guimarães
- [Repositório do Código](https://github.com/UnBArqDsw2025-2-Turma01/2025.2-T01-G8_Sei-PossoEnsinar_Entrega_03/tree/main/docs/Projeto/Decorator)

## Conclusão

Ao invés de criar classes monolíticas ou hierarquias complexas (ex: MonitorComAvaliacao, MonitorSemAvaliacao), conseguimos criar um sistema flexível onde responsabilidades de exibição (Competências, Avaliações) são adicionadas como "camadas" em tempo de execução.

A atividade validou como o padrão Decorator torna o código mais limpo, reutilizável e, o mais importante, extensível. Se no futuro precisarmos adicionar uma seção de "Conquistas" (Badges) ao perfil, basta criar um ConquistaDecorator sem modificar nenhuma das classes existentes, respeitando integralmente o Princípio Aberto/Fechado (OCP).

## Bibliografia

> REFACTORING GURU. Prototype design pattern. Disponível em: <https://refactoring.guru/design-patterns/prototype>.
...
> SERRANO, Milene. Arquitetura e Desenho de Software - Aula - GoFs Estruturais. Disponível em: https://aprender3.unb.br/pluginfile.php/3075186/mod_page/content/1/Arquitetura%20e%20Desenho%20de%20Software%20-%20Aula%20GoFs%20Estruturais%20-%20Profa.%20Milene.pdf.
